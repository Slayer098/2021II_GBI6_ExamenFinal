...
```{tex}
la tabla muestra, los niveles de expresion del cancer de mama en los diferentes genes 
...
ggsave("C:\\Users\\Anderson\\Desktop\\Borrador\\2021II_GBI6_ExamenFinal\\results\\boxplot3.png", width = 6, height = 8, dpi = 300)
...
ggsave("C:\\Users\\Anderson\\Desktop\\Borrador\\2021II_GBI6_ExamenFinal\\results\\regresion11.pdf", width = 6, height = 8, dpi = 300)
...
```{tex}
Al hacer la grafica de regresion lineal, se compara dos genes y se la aproximacion y relacion que poseen dichos genes en este caso GATA3 Y FN1, por la observacion existe un diferencia significativa. 
